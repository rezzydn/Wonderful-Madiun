package com.example.wonderfulmadiun.adjustment;
...
public class MarginAdjustment extends BaseMargin {

    public MarginAdjustment(@Px int spacing) {
        super(1, spacing);
    }

    public MarginAdjustment(int spanCount, @Px int spacing) {
