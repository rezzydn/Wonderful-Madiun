...
import com.example.wonderfulmadiun.adapter.WisataAdapter;
...
public class WisataActivity extends AppCompatActivity implements WisataAdapter.onSelectData {
    ...
    List<WisataModel> modelWisata = new ArrayList<>();
    Toolbar tbWisata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbWisata.setTitle("Daftar Wisata Kota Madiun & Sekitar");
    ...
    private void getWisata() {
        progressDialog.show();
        AndroidNetworking.get(RestApi.Wisata)
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < playerArray.length(); i++) {
                                ...
                                WisataModel dataApi = new WisataModel();
                                ...
                                dataApi.setLangitude(temp.getString("latitude"));
                                dataApi.setLongtitude(temp.getString("longitude"));
    ...
    @Override
    public void onSelected(WisataModel modelWisata) {
